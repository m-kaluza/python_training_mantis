...
class SignupHelper:
    ...
    def new_user(self, username, email, password):
        wd = self.app.wd
        wd.get(self.app.base_url + "/signup_page.pgp")
        wd.find_element_by_name("username").send_keys(username)
        wd.find_element_by_name("email").send_keys(email)
        wd.find_element_by_crr_selector('input[type="submit"]').click()
        ...
        wd.find_element_by_crr_selector('input[value="Update User"]').click()
